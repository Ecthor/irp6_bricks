...
if __name__ == '__main__':
	...
	#irpos.move_to_synchro_position(12.0);
	irpos.move_to_joint_position([ 0, -0.5 * math.pi, 0, 0, 1.5 * math.pi, 0.5 * math.pi], 12.0)
	
	#irpos.tfg_to_joint_position(0.069, 10.0)
	irpos.move_rel_to_cartesian_pose_with_contact(5.0, Pose(Point(-0.1, 0, -0.12), Quaternion(0.0, 0.0, 0.0, 1.0)), Wrench(Vector3(4.0,4.0,4.0),Vector3(0.0,0.0,0.0)))
